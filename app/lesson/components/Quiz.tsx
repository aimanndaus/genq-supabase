    ...
    return (
      <>
        ...
        <div className="flex flex-col gap-y-4 lg:gap-y-8 max-w-lg mx-auto items-center justify-center text-center h-full">
          <Image
            src="https://res.cloudinary.com/dhef1sxhg/image/upload/v1725002264/genq/asset/Icon_comfoty_aapqdl.gif"
            alt="Finished"
            height={200}
            width={200}
          ...
          <h1 className="text-xl lg:text-3xl text-neutral-700 font-bold">
            Kerennn Guys ! <br /> You've completed the lesson..
          </h1>
          ...
          <div className="lg:min-h-[350px] lg:w-[600px] w-full px-6 lg:px-0 flex flex-col gap-y-12">
            <h1 className="text-4xl lg:text-3xl text-center lg:text-start font-bold text-neutral-700">
              {currentChallenge.type === "ASSIST"
                ? currentChallenge.assist_question
                  ? currentChallenge.assist_question
            ...
            <div>
              {currentChallenge.type === "ASSIST" && (
                //features add sound and image
                <QuestionBubble
                  question={currentChallenge.question}
                  //audio must be null or string
                  audioUrl={currentChallenge.audioUrl || ""}
                  //img must be null or string
                  imgUrl={currentChallenge.imgUrl || ""}
